            ...
            <div class="footer-inner">
                <div class="row">
                        ...
                        <aside class="widget-container">
                            <div class="widget-content">
                                <div class="footer-logo mb-half">
                                    <img src="{{ asset('assets/sneakers/assets/images/footer-logo.png') }}"
                                         alt="Footer Logo">
                                </div>
                                <p>Chúng tôi là một nhóm gồm các nhà thiết kế và phát triển tạo ra Magento, Prestashop,
                                    Opencart chất lượng cao.</p>
                                <div class="footer-contact">
                                    <p><span>Địa chỉ:</span>Thôn 5, Xã Thượng Mỗ, Huyện Đan Phượng, Hà Nội</p>
                                    <p><span>Điện thoại:</span><a href="#">0969621079</a></p>
                                    <p><span>Email:</span><a href="#">tranvanh2k4@gmail.com</a></p>
                                </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 order-md-3 col-lg-2 order-lg-2">
                        <aside class="widget-container">
                            <h4 class="widgettitle">Danh mục</h4>
                            <div class="widget-content">
                        ...
                        <aside class="widget-container">
                            ...
                            <div class="widget-content">
                                <div class="newsletter-widget">
                                    <p>Bạn có thể hủy đăng ký bất cứ lúc nào. Vì mục đích đó, vui lòng tìm thông tin
                                        liên hệ của chúng tôi trong thông báo pháp lý.</p>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                    <p class="copyright-text">Copyright © 2024 <a href="#" rel="nofollow">
                        </a>. VanhSneaker.</p>
                </div>
                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="footer-payment">
                        <a href="#"><img src="{{ asset('assets/sneakers/assets/images/icons/payment.png') }}"
                                         alt="Payment Icons"></a>
                    </div>
                </div>
            </div> <!-- end of row -->
                                    ...
                                    <form action="#" class="product-actions">
                                            ...
                                            <ul class="d-flex flex-wrap align-items-center">
                                                <li class="box-quantity">
                                                    <div class="cart-input">
                                                        <input class="cart-input-box" type="text"
                                                               value="0">
                                                ...
                                                <li>
                                                    <button type="button" class="default-btn">Add to
                                                        Cart
                                                    </button>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="wishlist-compare">
                                            ...
                                            <button class="btn-compare" type="button"
                                                    title="Add to Compare">Add to Compare
                                            </button>
                                        </div>
                                    </form>
